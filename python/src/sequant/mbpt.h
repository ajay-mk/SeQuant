...
inline void __init__(py::module m) {
  ...
  py::enum_<sequant::mbpt::CC::Ansatz>(m, "Ansatz")
      ...
      .value("oT", sequant::mbpt::CC::Ansatz::oT,
  ...
  py::class_<sequant::mbpt::CC>(m, "CC")
      .def(py::init<size_t, sequant::mbpt::CC::Ansatz, bool, bool>(),
           py::arg("N"), py::arg("ansatz") = sequant::mbpt::CC::Ansatz::T,
           py::arg("screen") = true, py::arg("use_topology") = true,
           "Constructs CC engine\n\n"
           "Parameters\n"
           "----------\n"
           "N : int\n"
           "    Coupled cluster excitation rank (e.g., 2 for CCSD, 3 for "
           "CCSDT)\n"
           "ansatz : Ansatz, optional\n"
           "    Type of CC ansatz (T, oT, U, oU), default is T\n"
           "screen : bool, optional\n"
           "    If True, uses operator level screening before applying Wick's "
           "theorem, default is True\n"
           "use_topology : bool, optional\n"
           "    If True, uses topological optimizations in Wick's theorem, "
           "default is True")
      .def("ansatz", &sequant::mbpt::CC::ansatz, "Returns the type of ansatz")
      ...
      .def("t", &sequant::mbpt::CC::t, py::arg("commutator_rank") = 4,
           ...
           "pmax : int, optional\n"
           "    Highest particle rank of the projector manifold <P|, default "
           "is cluster rank\n"
           "pmin : int, optional\n"
           "    Lowest particle rank of the projector manifold <P|, default is "
           "0\n\n"
           "Returns\n"
           "-------\n"
           "list of ExprPtr\n"
           "    Vector of t amplitude equations, element k contains equation "
           "for rank k")
      .def("lambda_", &sequant::mbpt::CC::λ, py::arg("commutator_rank") = 4,
           ...
           "-------\n"
           "list of ExprPtr\n"
           "    Vector of λ amplitude equations, element k contains equation "
           "for rank k")
      .def("t_pt", &sequant::mbpt::CC::t_pt, py::arg("rank") = 1,
           py::arg("order") = 1, py::arg("nbatch") = std::nullopt,
      ...
      .def("lambda_pt", &sequant::mbpt::CC::λ_pt, py::arg("rank") = 1,
           py::arg("order") = 1, py::arg("nbatch") = std::nullopt,
      ...
      .def("eom_r", &sequant::mbpt::CC::eom_r, py::arg("np"), py::arg("nh"),
      ...
      .def("eom_l", &sequant::mbpt::CC::eom_l, py::arg("np"), py::arg("nh"),
